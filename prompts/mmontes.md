...
- [URL_MONTH]: https://media.mmontes-internal.duckdns.org/library/browse?q=year:[YEAR]+month:[MONTH_NUMBER]
  ([MONTH_NUMBER] = integer, not zero-padded, e.g. month:7)
- [URL_DAY]: https://media.mmontes-internal.duckdns.org/library/browse?q=taken:[YEAR]-[MM]-[DD]
